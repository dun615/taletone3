window.TALETONE_CONTENT = {
  "version": "1.0",
  "lastUpdated": "2026-07-06T13:02:38.466Z",
  "colorSchemes": {
    "abyss": {
      "stops": [
        [
  ...
  "projects": {
    "eyebrow": "ORIGINAL PROJECTS / IP READING",
    "title": "Original",
    "titleAccent": "Projects.",
    "subtitle": "직접 이야기를 기획해 본 팀입니다.",
    "description": "자체 IP 경험은 클라이언트의 세계관과 캐릭터를 더 입체적으로 해석하는 기반이 됩니다.",
    "cards": [
      {
        "id": "soraniwa",
        "slotId": "sora-art",
    ...
    "translations": {
      "kr": {
        ...
        "audienceTitle": "세계관이 있고, 팬이 있는 콘텐츠를 위해",
      ...
      "en": {
        ...
        "title": "Original",
        "titleAccent": "Projects.",
        "subtitle": "A team that has planned its own stories.",
        "description": "Our original IP experience helps us read a client world and its characters with more depth.",
        "cards": [
          {
            "label": "Original IP Project",
            "title": "soraniwa",
        ...
        "audienceTitle": "For content with a world, characters, and fans",
      ...
      "jp": {
        ...
        "title": "Original",
        "titleAccent": "Projects.",
        "subtitle": "自分たちでも物語を企画してきたチームです。",
        "description": "オリジナルIPの経験は、クライアントの世界観とキャラクターをより立体的に読む土台になります。",
        "cards": [
          {
            "label": "Original IP Project",
            "title": "soraniwa",
        ...
        "audienceTitle": "世界観があり、ファンがいるコンテンツのために",
  ...
  "contact": {
    ...
    "caption": "세계관, 캐릭터, 레퍼런스, 아직 정리되지 않은 아이디어도 괜찮습니다. 먼저 이야기를 듣고, 어울리는 음악의 방향을 함께 정리합니다.",
    ...
    "translations": {
      ...
      "en": {
        ...
        "caption": "Worldbuilding, characters, references, and unfinished ideas are all welcome. TALETONE listens first, then shapes the right musical direction with you.",
        "buttonLabel": "Project Inquiry"
      },
      "jp": {
        "eyebrow": "Project Inquiry",
        ...
        "subtitle": "必要な音楽は、一緒に探します。",
        "caption": "世界観、キャラクター、レファレンス、まだ整理されていないアイデアでも大丈夫です。まず物語を聞き、その物語に合う音楽の方向を一緒に整えます。",
        "buttonLabel": "Project Inquiry"
      }
    }
  },
  "membersMeta": {
    ...
    "translations": {
      ...
      "en": {
        "eyebrow": "THE TEAM THAT READS THE BRIEF",
        "title": "<span style=\"color:#335e6c\">Members</span>",
        "subtitle": "A team that reads stories and builds them into sound.",
        "description": "Planning, production, vocal, and visual leads read the brief together so music and character interpretation stay connected."
      },
      "jp": {
        "eyebrow": "THE TEAM THAT READS THE BRIEF",
        "title": "<span style=\"color:#335e6c\">Members</span>",
        "subtitle": "物語を読み、音として組み立てる人たち。",
        "description": "企画、プロダクション、ボーカル、ビジュアルの担当者が一緒にブリーフを読み、音楽とキャラクター解釈が分離しないように進行します。"
      }
    }
  },
  "translation": {
  ...
  "newsMeta": {
    ...
    "title": "Latest",
    "titleAccent": "News.",
    "subtitle": "새 소식은 짧게, 작업과 문의는 더 빠르게.",
    "description": "업데이트는 보조로 두고, 실제 작업물과 프로젝트 문의로 이어지게 정리합니다.",
    ...
    "translations": {
      ...
      "en": {
        ...
        "title": "Latest",
        "titleAccent": "News.",
        "subtitle": "Short updates, with faster paths to works and inquiries.",
        "description": "News stays as a supporting section while works and project contact lead the flow.",
        "readMoreLabel": "Read more →"
      },
      "jp": {
        "eyebrow": "UPDATES / NOTES",
        "title": "Latest",
        "titleAccent": "News.",
        "subtitle": "ニュースは短く、作品とお問い合わせへより早く。",
        "description": "更新情報は補助的に置き、作品とプロジェクト相談への流れを優先します。",
        "readMoreLabel": "Read more →"
      }
    }
  },
